  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="#f5f5f5"
      ></rect>
      <circle cx="99.24" cy="194.37" r="5.36" fill="#ff5252"></circle>
      <circle cx="113.97" cy="194.37" r="5.36" fill="#ff0"></circle>
      <circle cx="128.71" cy="194.37" r="5.36" fill="#69f0ae"></circle>
      <text x="-149.95" y="-101.66"></text>
      <g opacity="0.8">
        <path
      ...
      <path
        ...
        fill="#f5f5f5"
      ></path>
      <circle cx="81.78" cy="631.94" r="4.54" fill="#e0e0e0"></circle>
      <circle cx="95.41" cy="631.94" r="4.54" fill="#e0e0e0"></circle>
      <circle cx="109.03" cy="631.94" r="4.54" fill="#e0e0e0"></circle>
      <path
        ...
        fill="#161618"
      ></path>
      <circle cx="436.28" cy="179.39" r="142.22" fill="#333"></circle>
      <path
      ...
      <path
        ...
        opacity="0.1"
      ></path>
      <circle cx="436.28" cy="210.26" r="142.22" fill="#fdb797"></circle>
      <path
