...
export const navLinks:NavLinks = {
    ...
    transactions: [{href: '/dashboard/transactions/wallet', label: 'Wallet Funding History', icon: 'wallet'}, {label: 'Data Purchases', href: '/dashboard/transactions/data', icon: 'order'}, {label: 'Airtime Purchases', href: '/dashboard/transactions/airtime', icon: 'order'},{label: 'Electricity Bills', href: '/dashboard/transactions/electricity', icon: 'bills'}, {label: 'CableTv Bills', href: '/dashboard/transactions/cabletv', icon: 'bills'}]
}
